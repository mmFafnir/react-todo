  ...
  return ( 
    <div className={ openSidebar ? 'todo__sidebar todo-sidebar open' : 'todo__sidebar todo-sidebar'}>
        <button onClick={clickSidebar} className='todo-open'>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sliders-h" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-sliders-h fa-w-16 fa-7x">
